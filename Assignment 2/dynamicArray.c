 ...
 * Date: 10/14/2015
 * Solution description: Learning to use and program dynamic arrays, with various subfunctions to make the process more efficient.
 */
...
void _dynArrSetCapacity(DynArr *v, int newCap)
{
    ...
    TYPE *moveData = v->data;
    int aSize = sizeDynArr(v), i;
    initDynArr(v, newCap);
